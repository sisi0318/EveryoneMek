...
def generate(mek_jar):
    ...
    pairs = {
        ...
        'key.categories.overloadcore': ('过载核心', 'Overload Core'), 'key.overloadcore.status': ('核心状态／潜行切换工况提示', 'Core Status / Sneak to Toggle Diagnostics'),
        ...
        'overloadcore.effects': ('%s 格内，自有及授权设备耗电翻倍，发电和物流受限。', 'Within %s blocks: owned/shared machines draw double power; generation and transport are reduced.'),
        'overloadcore.benefits': ('部分配方增产，额外电耗可回收给随身装备。', 'Selected recipes produce more; excess power can recharge your gear.'),
        'overloadcore.details_hint': ('按住右键两秒装备；K 查看说明，潜行＋K 显示设备位置。', 'Hold use for two seconds to bind. K: details; sneak + K: diagnostics.'),
        ...
        'overloadcore.bound': ('核心已绑定。', 'Core bound.'),
        ...
        'overloadcore.page': ('诅咒／收益', 'Curses / Benefits'), 'overloadcore.close': ('关闭', 'Close'),
        'overloadcore.sharing_hint': ('对准自有设备：/overloadcore share 玩家；取消用 unshare。', 'Aim at your device: /overloadcore share <player>; use unshare to revoke.'),
    ...
    curses = [
        ('熔接绑定：无法主动卸下，死亡仍保留。', 'Welded bond: cannot be removed in survival; kept on death.'),
        ('寄生电阻：实际工作耗电翻倍。', 'Parasitic resistance: double working energy cost.'),
        ('失相发电：新生成的电量减半。', 'Phase loss: half the generated energy.'),
        ('漏电排斥：贴近工作机器会被电击推开。', 'Short circuit: nearby working machines shock and repel you.'),
        ('总线拥塞：适用端点的分配流量减半。', 'Bus congestion: reduced delivery at affected endpoints.'),
        ('电磁耳鸣：噪声放大，持续暴露后反胃。', 'Interference: louder machines; prolonged noise causes nausea.'),
        ('磁性重载：携带过量金属时无法奔跑。', 'Magnetic load: too much carried metal prevents sprinting.'),
        ('热失衡：靠近热源积累体热，过热持续受伤。', 'Thermal stress: heat exposure builds up and eventually hurts.'),
    ]
    gifts = [
        ('极限良率：指定矿物入口和基础元件产物翻倍。', 'Yield: selected ore-entry and basic-component outputs are doubled.'),
        ('漏电回收：回收额外电耗的 25%，供给随身机具。', 'Recovery: 25% of the extra energy can charge carried gear.'),
        ('机具共振：有电的 MekaTool 挖掘效率提高 25%。', 'Resonance: a powered MekaTool mines 25% faster.'),
        ('工况感知：显示附近授权设备和热源位置。', 'Diagnostics: locate nearby permitted devices and heat sources.'),
    ]
