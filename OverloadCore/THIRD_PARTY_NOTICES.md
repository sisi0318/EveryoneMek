...
- The Thunder Ward bracelet sprite is also original built-in ImageGen output; its source and full prompt are kept in `art/source/thunder_ward.png` and `art/thunder-ward-prompt.txt`. Curios supplies its existing empty-bracelet slot icon at runtime.
