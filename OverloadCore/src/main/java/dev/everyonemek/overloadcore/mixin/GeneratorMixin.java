...
public abstract class GeneratorMixin {
    @WrapOperation(method = "onUpdateServer", at = @At(value = "INVOKE", target = "Lmekanism/common/capabilities/energy/BasicEnergyContainer;insert(JLmekanism/api/Action;Lmekanism/api/AutomationType;)J"))
