...
public abstract class GeneratorFusionMixin {
    @WrapOperation(method = "transferHeat", at = @At(value = "INVOKE", target = "Lmekanism/api/energy/IEnergyContainer;insert(JLmekanism/api/Action;Lmekanism/api/AutomationType;)J"))
