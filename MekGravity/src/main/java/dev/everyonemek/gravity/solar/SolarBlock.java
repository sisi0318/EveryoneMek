...
public final class SolarBlock extends BaseEntityBlock {
    ...
    @Override protected net.minecraft.world.phys.shapes.VoxelShape getCollisionShape(BlockState s,BlockGetter l,BlockPos p,net.minecraft.world.phys.shapes.CollisionContext c){return kind==Kind.SEED?net.minecraft.world.phys.shapes.Shapes.empty():kind==Kind.FOCUS?dev.everyonemek.gravity.ModelShapes.coil(s.getValue(FACING)):super.getCollisionShape(s,l,p,c);}
