...
public final class SolarScreen extends GuiMekanismTile<SolarController,SolarMenu> {
    ...
    private Component duration(){if(tile.gross<=0)return SolarContent.text("paused");long seconds=tile.fuelRemaining/tile.gross/20;return SolarContent.text("remaining_time",seconds/3600,seconds/60%60,seconds%60);}
