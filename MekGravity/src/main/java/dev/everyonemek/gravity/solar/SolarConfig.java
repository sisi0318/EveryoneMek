...
public final class SolarConfig {
    ...
    static{var b=new ModConfigSpec.Builder();
        ...
        HEAT_DAMAGE=b.comment("Stellar heat damage multiplier; zero keeps warnings but disables burning.").defineInRange("stellarHeatDamageMultiplier",1D,0D,100D);SPEC=b.build();}
    private SolarConfig(){}
}
