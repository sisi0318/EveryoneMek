...
public final class SolarConfig {
    ...
    static{var b=new ModConfigSpec.Builder();
        ...
        CORE_CONTACT_DAMAGE=b.comment("Base damage inside the innermost 0.45-block core; multiplied by stellarHeatDamageMultiplier.").defineInRange("stellarCoreContactDamage",1_000_000D,0D,1_000_000_000D);SPEC=b.build();}
    private SolarConfig(){}
}
