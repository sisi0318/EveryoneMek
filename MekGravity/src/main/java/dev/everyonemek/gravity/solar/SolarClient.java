...
public final class SolarClient {
    ...
    @SubscribeEvent public static void itemExtensions(net.neoforged.neoforge.client.extensions.common.RegisterClientExtensionsEvent e){SolarSeedItemRenderer.register(e);}
