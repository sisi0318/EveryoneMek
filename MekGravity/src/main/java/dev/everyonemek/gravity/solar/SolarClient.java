...
public final class SolarClient {
    @SubscribeEvent public static void screens(RegisterMenuScreensEvent e){e.register(dev.everyonemek.gravity.corona.CoronalContent.MENU.get(),dev.everyonemek.gravity.corona.CoronalScreen::new);e.register(SolarContent.MENU.get(),SolarScreen::new);e.register(SolarContent.FUEL_MENU.get(),SolarFuelScreen::new);}
    @SubscribeEvent public static void renderers(EntityRenderersEvent.RegisterRenderers e){e.registerBlockEntityRenderer(dev.everyonemek.gravity.corona.CoronalContent.TILE.get(),dev.everyonemek.gravity.corona.CoronalRenderer::new);e.registerBlockEntityRenderer(SolarContent.PART.get(),SolarRenderer::new);}
    @SubscribeEvent public static void models(ModelEvent.RegisterAdditional e){SolarRenderer.additional(e);}
    @SubscribeEvent public static void shaders(RegisterShadersEvent e){dev.everyonemek.gravity.corona.CoronalShader.register(e);SolarShader.register(e);SolarFieldShader.register(e);dev.everyonemek.gravity.client.GravityRingShader.register(e);}
