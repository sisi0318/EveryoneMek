...
public final class MekGravity {
    ...
    public MekGravity(IEventBus bus,ModContainer container){
        ...
        Content.register(bus);bus.addListener(Ports::register);bus.addListener(dev.everyonemek.gravity.expansion.LinkPanelNetwork::register);bus.addListener(ReactorConfig::loaded);
        ...
        NeoForge.EVENT_BUS.addListener(dev.everyonemek.gravity.expansion.FieldLinker::interact);
        dev.everyonemek.gravity.expansion.ModuleContent.register(bus);bus.addListener(dev.everyonemek.gravity.expansion.ModuleConfig::loaded);container.registerConfig(ModConfig.Type.SERVER,dev.everyonemek.gravity.expansion.ModuleConfig.SPEC,"mekgravity-modules-server.toml");
