...
public final class MekGravity {
    ...
    public MekGravity(IEventBus bus,ModContainer container){
        ...
        dev.everyonemek.gravity.expansion.ModuleContent.register(bus);container.registerConfig(ModConfig.Type.SERVER,dev.everyonemek.gravity.expansion.ModuleConfig.SPEC,"mekgravity-modules-server.toml");
