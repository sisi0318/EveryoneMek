...
public final class ReactorTab extends GuiWindowCreatorTab<Controller,ReactorTab> {
    ...
    public ReactorTab(IGuiWrapper gui,Controller c,ReactorMenu menu,ReactorWindow.Page page,Supplier<ReactorTab> self){
        super(MekanismUtils.getResource(page==ReactorWindow.Page.STRUCTURE?ResourceType.GUI:ResourceType.GUI_TAB,page==ReactorWindow.Page.STRUCTURE?"configuration.png":"energy_info.png"),gui,c,-26,page==ReactorWindow.Page.ENERGY?22:50,26,18,true,self);
