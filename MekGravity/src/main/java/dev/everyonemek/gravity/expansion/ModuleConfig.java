...
public final class ModuleConfig {
    ...
    static{var b=new ModConfigSpec.Builder();RANGE=b.defineInRange("linkRange",128,16,512);BATCH=b.defineInRange("processingBatch",64,1,512);TRANSFER=b.defineInRange("itemsPerNodePerTick",36864,1,36864);ITEM_COST=b.defineInRange("joulesPerTransferredItem",1_000_000L,1,1_000_000_000L);
