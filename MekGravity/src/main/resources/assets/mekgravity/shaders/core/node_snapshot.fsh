...
void main(){
    ...
    float scan=.78+.22*smoothstep(.15,.65,fract(localUv.y*10.0-flowPhase/6.2831853));
    float sweep=pow(max(0.0,cos(localUv.y*6.2831853-flowPhase)),12.0);
