...
const panels=frames.map((f,index)=>{
  ...
  return {label:`Phase ${f.phase} / running`,labelX:25+index*470,labelY:35,x:235+index*470,y:350,scale:60,elevation:.26,instances:[
...
render('solar-field-preview.png',panels,1410,700).catch(e=>{process.stderr.write(e.stack+'\n');process.exitCode=1;});
