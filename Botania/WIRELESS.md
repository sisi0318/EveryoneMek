...
**原型更新：0.1.0-alpha.6 已实现原生池与本模组机器的收发、中继、成员权限、费用和共享带宽。** 当前 UI 使用可搜索列表、同页“用途接入”及直接模式／方向按钮；机器端点遵守实际六面接口与 Mek 权限。可视连接线、任意第三方储罐及高级网络仍属后续提案。实际功能以 [README](README.md) 为准。
