...
本方案接续 [总体设计](DESIGN.md)，保留用户已接受的导能莲产能与非土壤安装方案，记录无线魔力网络的完整目标。

**原型更新：0.1.0-alpha.1 已实现原生池之间的收发、中继、成员权限、费用和共享带宽。** 当前 UI 使用循环选择网络和字段配置；加工机／Chemical 接入、可视连接线及高级网络仍在规划中。实际功能以 [README](README.md) 为准。
...
只在实现对应步骤时运行相关无界面验证。当前文档已区分提案数值与上游事实，没有运行结果或可安装产物。
