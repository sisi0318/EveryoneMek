...
**0.1.0-alpha.2 可运行原型**：提供仿生导能莲、仿生翡翠苋、共鸣花和共鸣芽。加工机器、Mek Chemical 魔力互通器、其余仿生功能花和跨维度网络仍在规划中。
...
本模组 JAR 为 `build/libs/BotanicalMekanism-0.1.0-alpha.2.jar`。Botania 来源与校验值见 [upstream-lock.json](upstream-lock.json)和[官方 CI](https://github.com/VazkiiMods/Botania/actions/runs/34246437545)；同名 SNAPSHOT 不保证相同内容，请使用锁定文件。JEI 非必需，四种方块均有普通工作台合成。
...
配置界面采用接近原生魔力 HUD 的半透明深底，以原花图标、细魔力条和少量花种主题色呈现储量、供魔关系与网络设置。悬停发射器图标查看真实绑定坐标，悬停授权成员查看名单。模式切换、按钮与回车提交均使用服务端确认值。
