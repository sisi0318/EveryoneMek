...
public final class Balance {
    ...
    public static final ModConfigSpec.IntValue CORPOREA_TRANSFER = BUILDER.comment("Maximum items transferred by one Corporea/ME flower per world tick, shared by both directions.")
          .defineInRange("corporeaItemsPerTick", 2048, 64, 65536);
