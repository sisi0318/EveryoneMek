...
public final class ApothecaryGameTests {
    ...
    public static void bionicRecipesAreExclusiveAtomicAndSurviveMachineDrops(GameTestHelper h) {
        ...
        check(recipes.getAllRecipesFor(ApothecaryContent.RECIPE_TYPE.get()).size() == Content.bionics().length + 1 + (net.neoforged.fml.ModList.get().isLoaded("ae2") ? 1 : 0), "Mechanical flower recipes failed to load");
